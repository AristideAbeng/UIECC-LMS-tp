...
public class LecturerCellRenderer extends JPanel implements ListCellRenderer<Lecturer>{
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends Lecturer> list, Lecturer value, int index, boolean isSelected, boolean cellHasFocus) {
      lbl_nomEtPrenom.setText(value.getNomEtPrenom());
       lbl_filiere.setText(value.getDepartment());
